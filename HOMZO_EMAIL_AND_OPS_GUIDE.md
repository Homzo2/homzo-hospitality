...
**Status:** ✅ Live & Configured (26 September 2026)  
**Domain:** `homzo.co.in`
...
This document outlines the active email distribution designed for:
...
## 📬 2. The 5 Core Accounts (Departmental Blueprint — Active)

| # | Primary Account Email | Active Aliases | Role / Department | Function & Scope |
|---|---|---|---|---|
| 1 | **`rishabh@homzo.co.in`** | `marketing@`, `growth@` | **Founder / Executive Office** | • Official statutory registrations (GST, MSME, Banking)<br>• Confidential contracts, legal documents, executive decisions<br>• Master account for SaaS tools and platforms |
| 2 | **`booking@homzo.co.in`** | `bookings@`, `stay@` | **Front Desk & Reservations** | • Automated guest booking confirmations & invoices<br>• OTA channel integrations (MakeMyTrip, Agoda, Booking.com)<br>• Pre-arrival check-in info, WiFi/door codes, stay modifications |
| 3 | **`support@homzo.co.in`** | `info@`, `contact@` | **Guest Care & Escalations** | • 24/7 guest support during stay (amenities, cleanliness, room service)<br>• Refund, cancellation, and customer escalation management<br>• Guest review responses and feedback collection |
| 4 | **`partner@homzo.co.in`** | `sales@`, `partners@` | **Property Acquisition & Supply** | • Hotel owner onboarding, franchise requests, and inventory lease proposals<br>• Direct communication channel for the Admin Partner Portal (`/partner`)<br>• Property verification and BDM sales leads |
| 5 | **`account@homzo.co.in`** | `accounts@`, `billing@`, `payouts@` | **Finance, Billing & Payouts** | • Payment gateway settlements (Razorpay, Stripe, UPI)<br>• Monthly/weekly partner revenue disbursement reports<br>• Vendor invoices (laundry, toiletries, maintenance, utilities) |
